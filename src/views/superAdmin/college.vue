  ...
  <el-dialog :title="title" :visible.sync="dialogFormVisible" :show-close="false" width="30%" center>
    <el-form :model="form">
      <el-form-item label="学院名称" :label-width="formLabelWidth">
        <el-input v-model="form.collegeName" autocomplete="off" style="width: 300px;"></el-input>
      </el-form-item>
    </el-form>
...
export default {
  ...
  components: {
    ...
    mounted () {
      ...
      //   console.log('使用缓存数据')
      // }
        this.axios("/admin/selectcollege?pageSize="+this.pageSize+'&pageNo='+this.pageNo+'&'+ (new Date()).getTime().toString()).then(res=>{
            console.log(res)
